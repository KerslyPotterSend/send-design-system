// Source of truth: Figma variable export (Primitive: Colour + Semantic: Color).
// Values are derived from the primitives below — do not edit semantic tokens
// by hand; change the primitive and let it flow through.

// =============================================================================
// PRIMITIVES — Figma "Primitive: Colour"
// =============================================================================
...
// =============================================================================
// Display-only primitive ramps used by the swatch screens. Order: lightest → darkest
// for `light`, darkest → lightest for `dark` (matches how Figma presents them).
// =============================================================================

export const base = {
  light: {
    base1: primary.white,
    base2: palette.neutral[50],
    base3: palette.neutral[100],
    base4: palette.neutral[200],
    base5: palette.neutral[300],
    base6: palette.neutral[400],
    base7: palette.neutral[500],
    base8: palette.neutral[600],
    base9: palette.neutral[700],
    base10: palette.neutral[800],
    base11: palette.neutral[900],
    base12: primary.dark,
  },
  dark: {
    base1: palette.dark[900],
    base2: palette.dark[800],
    base3: palette.dark[700],
    base4: palette.dark[600],
    base5: palette.dark[500],
    base6: palette.dark[400],
    base7: palette.dark[300],
    base8: palette.dark[200],
    base9: palette.dark[100],
    base12: primary.white,
  },
};

export const brand = {
  light: {
    brand1: palette.brand[100],
    brand2: palette.brand[200],
    brand3: palette.brand[300],
    brand4: palette.brand[400],
    brand5: palette.brand[500],
    brand6: palette.brand[600],
    brand7: palette.brand[700],
    brand8: palette.brand[800],
    brand9: palette.brand[900],
  },
  dark: {
    brand1: palette.brand[900],
    brand2: palette.brand[800],
    brand3: palette.brand[700],
    brand4: palette.brand[600],
    brand5: palette.brand[500],
    brand6: palette.brand[400],
    brand7: palette.brand[300],
    brand8: palette.brand[200],
    brand9: palette.brand[100],
  },
};

// =============================================================================
// SEMANTIC TOKENS — Figma "Semantic: Color"
// =============================================================================

export const content = {
  light: {
    contentPrimary: palette.neutral[900],
    contentSecondary: palette.neutral[500],
    contentTertiary: palette.neutral[200],
    contentBrand: palette.brand[600],
    contentBrandHover: palette.brand[700],
    contentBrandPress: palette.brand[800],
  },
  dark: {
    contentPrimary: primary.white,
    contentSecondary: palette.neutral[400],
    contentTertiary: palette.neutral[700],
    contentBrand: palette.brand[500],
...
export const layerTokens = {
  light: {
    layer1Background: palette.neutral[50],
    layer1BackgroundHover: palette.neutral[100],
    layer1BackgroundPress: palette.neutral[200],
    layer1BackgroundFocus: palette.neutral[50],
    layer1BackgroundDisabled: palette.neutral[50],
    layer1BorderColor: palette.neutral[50],
    layer1BorderColorHover: palette.neutral[300],
    layer1BorderColorPress: palette.neutral[100],
    layer1BorderColorFocus: palette.brand[700],
    layer1BorderColorDisabled: palette.neutral[100],
    layer1OutlineColor: palette.brand[700],

    layer2Background: primary.white,
    layer2BackgroundHover: palette.neutral[50],
    layer2BackgroundPress: palette.neutral[100],
    layer2BackgroundFocus: primary.white,
    layer2BackgroundDisabled: primary.white,
    layer2BorderColor: palette.neutral[200],
    layer2BorderColorHover: palette.neutral[300],
    layer2BorderColorPress: palette.neutral[200],
    layer2BorderColorFocus: palette.brand[700],
    layer2BorderColorDisabled: palette.neutral[100],
    layer2OutlineColor: palette.brand[700],

    layer3Background: palette.neutral[50],
    layer3BackgroundHover: palette.neutral[100],
    layer3BackgroundPress: palette.neutral[100],
    layer3BackgroundFocus: palette.neutral[50],
    layer3BackgroundDisabled: palette.neutral[50],
    layer3BorderColor: palette.neutral[200],
    layer3BorderColorHover: palette.neutral[200],
    layer3BorderColorPress: palette.neutral[300],
    layer3BorderColorFocus: palette.brand[700],
    layer3BorderColorDisabled: palette.neutral[200],
    layer3OutlineColor: palette.brand[700],
  },
  dark: {
    layer1Background: palette.dark[700],
    layer1BackgroundHover: palette.dark[600],
    layer1BackgroundPress: palette.dark[800],
    layer1BackgroundFocus: palette.dark[700],
    layer1BackgroundDisabled: palette.dark[700],
    layer1BorderColor: palette.dark[700],
    layer1BorderColorHover: palette.dark[400],
    layer1BorderColorPress: palette.dark[600],
    layer1BorderColorFocus: palette.brand[500],
    layer1BorderColorDisabled: palette.dark[600],
    layer1OutlineColor: palette.brand[500],

    layer2Background: palette.dark[500],
    layer2BackgroundHover: palette.dark[400],
    layer2BackgroundPress: palette.dark[600],
    layer2BackgroundFocus: palette.dark[500],
    layer2BackgroundDisabled: palette.dark[500],
    layer2BorderColor: palette.dark[300],
    layer2BorderColorHover: palette.dark[200],
    layer2BorderColorPress: palette.dark[400],
    layer2BorderColorFocus: palette.brand[500],
    layer2BorderColorDisabled: palette.dark[400],
    layer2OutlineColor: palette.brand[500],

    layer3Background: palette.dark[400],
    layer3BackgroundHover: palette.dark[300],
    layer3BackgroundPress: palette.dark[500],
    layer3BackgroundFocus: palette.dark[400],
    layer3BackgroundDisabled: palette.dark[400],
    layer3BorderColor: palette.dark[300],
    layer3BorderColorHover: palette.dark[200],
    layer3BorderColorPress: palette.dark[400],
    layer3BorderColorFocus: palette.brand[500],
    layer3BorderColorDisabled: palette.dark[300],
    layer3OutlineColor: palette.brand[500],
  },
};

export const brandTokens = {
  light: {
    brandBackground: palette.brand[600],
    brandBackgroundHover: palette.brand[700],
    brandBackgroundPress: palette.brand[800],
    brandBackgroundFocus: palette.brand[600],
    brandBackgroundDisabled: palette.brand[200],
    brandBorderColor: palette.brand[600],
    brandBorderColorHover: palette.brand[700],
    brandBorderColorPress: palette.brand[800],
    brandBorderColorFocus: palette.brand[500],
    brandBorderColorDisabled: palette.brand[200],
    brandOutlineColor: palette.brand[500],
    brandColor: primary.white,
    brandColorPress: palette.neutral[100],
    brandColorDisabled: primary.white,
  },
  dark: {
    brandBackground: palette.brand[500],
    brandBackgroundHover: palette.brand[400],
    brandBackgroundPress: palette.brand[600],
    brandBackgroundFocus: palette.brand[500],
    brandBackgroundDisabled: palette.brand[900],
    brandBorderColor: palette.brand[500],
    brandBorderColorHover: palette.brand[400],
    brandBorderColorPress: palette.brand[600],
    brandBorderColorFocus: palette.brand[400],
    brandBorderColorDisabled: palette.brand[900],
    brandOutlineColor: palette.brand[400],
    brandColor: palette.dark[500],
    brandColorPress: palette.dark[400],
    brandColorDisabled: palette.dark[300],
  },
};

// =============================================================================
// Radix scales — Figma "Semantic: Color → Radix Color". Keys are 1 → 12.
// =============================================================================
...
export const radix = {
  dark: {
    ...
    Sage:    { 1: '#101211', 2: '#171918', 3: '#202221', 4: '#272a29', 5: '#2e3130', 6: '#373b39', 7: '#444947', 8: '#5b625f', 9: '#63706b', 10: '#717d79', 11: '#adb5b2', 12: '#eceeed' },
